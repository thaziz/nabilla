<div id="konsinyasi" class="tab-pane fade in active">
  <form method="post">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
           ...
           <div class="col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-top: 15px;padding-top: 15px;">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <label>Nama Item / Bahan Baku</label>
              </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">      
          <div style="padding-top: 20px;padding-bottom: 20px;">     
            <div class="table-responsive">
              <table class="table tabelan table-bordered table-hover dt-responsive data-table" id="t72">
               <thead align="right">
                <tr>
                 <th>Kode</th>
                 <th>Nama</th>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" >
              ...
              <div class="col-md-5 col-md-offset-7 col-sm-6 col-sm-offset-6 col-xs-12 tamma-bg" style="margin-bottom: 20px; padding-bottom:5px;padding-top: 10px;">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <label class="control-label tebal" for="kembalian">Kembalian</label>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <div class="form-group">
                                    <div class="input-group input-group-sm" style="width: 100%;">
                                      <input type="text" id="ongkos_kirim" name="" class="form-control" style="text-align: right;" onkeyup="javascript: if(isNaN(this.value) || parseInt(this.value) < 0) { this.value='0';this.select(); }">
                                    </div>
                                  </div>
                                </div>
