        ...
        <div class="col-md-12 col-sm-12 col-xs-12">      
          <div style="padding-top: 20px;padding-bottom: 20px;">     
            <div class="table-responsive">
              <table class="table tabelan table-bordered table-hover dt-responsive data-table" id="t10m">
               <thead align="right">
                <tr>
                 <th>Kode</th>
                 <th>Nama</th>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <div class="form-group">
                                    <div class="input-group input-group-sm" style="width: 100%;">
                                      <input type="text" id="ongkos_kirim" name="" class="form-control" style="text-align: right;" onkeyup="numberOnly()">
                                    </div>
                                  </div>
                                </div>
