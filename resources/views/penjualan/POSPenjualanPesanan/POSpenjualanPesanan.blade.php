                        ...
                        <div class="row mbl">
                            <div class="col-lg-12">
                              ...
                              <ul id="generalTab" class="nav nav-tabs">
                                <li class="active"><a href="#pesanan" data-toggle="tab">Penjualan Pesanan</a></li>
                                <li><a href="#listpesanan" data-toggle="tab">List Penjualan Pesanan</a></li>
                              ...
                              <div id="generalTabContent" class="tab-content responsive">
                                <!-- Modal -->
                                @include('penjualan.POSpenjualanPesanan.modal')
                                <!-- End Modal -->
                                
                                <!-- div #alert-tab -->
                                @include('penjualan.POSpenjualanPesanan.pesanan')
                                <!-- /div #alert-tab -->

                                <!-- Div #listtoko -->
                                @include('penjualan.POSpenjualanPesanan.listpesanan')
                                <!-- end div #listoko -->
...
@section("extra_scripts")
    ...
    $('#t64 tbody').on( 'click', '.delete', function () {
    table
        .row( $(this).parents('tr') )
        .remove()
        .draw();
