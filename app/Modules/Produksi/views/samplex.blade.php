...
<script src="{{ asset ('assets/c/3rdparty/jquery-1.10.2.js') }}"></script>
<script src="{{ asset ('assets/c/js/qz-websocket.js') }}"></script>
...
function printHTML() {
    ...
    var colA = fixHTML('<div style="text-align: right;"><h2>*  QZ Print Plugin HTML Printing  *</h2></div>');
    ...
    //qz.setCopies(3);
      ...
      $.ajax({
    url : baseUrl + "penjualan/pos-toko/printNote/1",
    type: 'get',
...
<div style="margin: 0 1em;"><h1 style="margin:0;">QZ Print Plugin <span id="version"></span></h1></div>

<table border="1px" cellpadding="5px" cellspacing="0px">
<tr>
    <td valign="top"><h2>All Printers</h2>
        <a href="javascript:launchQZ();">Launch QZ Tray</a><br /><br />
        <input type="button" onClick="findPrinter()" value="Detect Printer"><br />
        <input id="printer" type="text" value="POS-80" size="15"><br />
    ...
    <td valign="top"><h2>Raw Printers Only</h2>
        <a href="https://qz.io/wiki/What-is-Raw-Printing" target="new">What is Raw Printing?</a><br /><br />
    ...
    <td valign="top"><h2>PostScript Printers Only</h2>
        <a href="https://qz.io/wiki/What-is-PostScript-Printing" target="new">What is PostScript Printing?</a><br />
